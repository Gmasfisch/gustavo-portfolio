...
# Example
./pipex_bonus input.txt "shuf" "head -n 5" "tr '\n' ' '" output.txt (assuming you have numbers separated by a newline in input.txt)
./pipex_bonus here_doc LIMITER "cat" "wc -c" output.txt
```
